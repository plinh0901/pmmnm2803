...
if ( ! function_exists( 'lectura_lite_get_pages' ) ) :
/**
 ...
 */
function lectura_lite_get_pages() {

    $choices = array( 0 );

    // Default
    $choices = array( 'none' => esc_html__( 'None', 'lectura-lite' ) );
    ...
    return apply_filters( 'lectura_lite_get_pages', $choices );
}
endif;

if ( ! function_exists( 'lectura_lite_sanitize_pages' ) ) :
/**
 ...
 */
function lectura_lite_sanitize_pages( $value ) {
...
if ( ! function_exists( 'lectura_lite_get_categories' ) ) :
/**
 ...
 */
function lectura_lite_get_categories() {
    ...
    return apply_filters( 'lectura_lite_get_categories', $choices );
}
endif;

if ( ! function_exists( 'lectura_lite_sanitize_categories' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function lectura_lite_sanitize_categories( $value ) {

    $choices = lectura_lite_get_categories();
    $valid   = array_keys( $choices );
...
if ( ! function_exists( 'lectura_lite_get_tags' ) ) :
/**
 ...
 * @return array                The list of terms.
 */
function lectura_lite_get_tags() {
    ...
    return apply_filters( 'lectura_lite_get_tags', $choices );
}
endif;

if ( ! function_exists( 'lectura_lite_sanitize_tags' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function lectura_lite_sanitize_tags( $value ) {

    $choices = lectura_lite_get_tags();
    $valid   = array_keys( $choices );
